...
def train_model(args):
    ...
    author = config_data["training"]["author"]
    ...
    species_checklist_w_accuracy_csv_path = (
        model_save_path
        + model_name
        + "_"
        + "checklist-accuracy"
    ...
    species_checklist_w_accuracy.to_csv(
        species_checklist_w_accuracy_csv_path, index=False
    )
    species_checklist_w_accuracy_table_artifact.add_file(
        species_checklist_w_accuracy_csv_path
    )
