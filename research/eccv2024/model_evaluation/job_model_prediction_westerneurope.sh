#!/bin/bash
#SBATCH --job-name=westerneurope_resnet50_baseline_run1
#SBATCH --partition=long                      # Ask for long job
#SBATCH --cpus-per-task=2                     # Ask for 2 CPUs
#SBATCH --gres=gpu:rtx8000:1                  # Ask for 1 GPU
#SBATCH --mem=10G                             # Ask for 10 GB of RAM
#SBATCH --output=westerneurope_resnet50_baseline_run1.out
...
--moth_model westerneurope_resnet50_baseline_run1.pth \
--moth_model_type resnet50 \
--category_map_binary_model "05-moth-nonmoth_category_map.json" \
--category_map_moth_model "02_moths_westernEurope_category_map.json" \
