...
for column in sp_data.columns:
    acc_data_sp.append(round(sp_data.loc["correct"][column]/sp_data.loc["conf-total"][column]*100,2))
    rej_data_sp.append(round(sp_data.loc["reject"][column]/sp_data.loc["moths-total"][column]*100,2))
    acc_data_gs.append(round(gs_data.loc["correct"][column]/gs_data.loc["conf-total"][column]*100,2))
    rej_data_gs.append(round(gs_data.loc["reject"][column]/gs_data.loc["moths-total"][column]*100,2))
    acc_data_fm.append(round(fm_data.loc["correct"][column]/fm_data.loc["conf-total"][column]*100,2))
...
legend_elements = [Line2D([0], [0], color='black', label='Top-1 Accuracy'),
