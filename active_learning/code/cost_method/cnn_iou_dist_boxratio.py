...
class TrackingCost:
	def __init__(self, image1, image2, bb1, bb2, model, img_diagonal, weights, img_resize=224, device='cuda'):
		"""
		...
		self.bb1        = bb1
		self.bb2        = bb2
		self.img_diag   = img_diagonal
		self.w_cnn      = weights[0]
		self.w_iou      = weights[1]
		self.w_box      = weights[2]
		self.w_dis      = weights[3]
	...
	def final_cost(self):
		...
		self.total_cost = self.w_cnn*cnn_cost + self.w_iou*iou_cost + self.w_box*box_ratio_cost + self.w_dis*dist_ratio_cost
